...
<p align="center">
  <img src="https://iili.io/CsmO1HJ.md.png" alt="Logo" width="400"/>
</p>

<p align="center">
  A powerful, self-hosted <b>CineFlow Stream Media Server</b> built with <b>FastAPI</b>, <b>MongoDB</b>, and <b>PyroFork</b> — turn your Telegram channels into a private streaming library you watch in <b>Stremio</b> / <b>Nuvio</b>.
</p>
...
<p align="center">
  <a href="https://github.com/cineflow-web/CineFlow_Watch/releases/latest">
...
- So to update: make sure *Upstream Repo* = `https://github.com/cineflow-web/CineFlow_Watch` (and branch, e.g. `master`) in Settings → click **Restart**. Done. 🎉
...
| **Upstream Repo / Branch** | Used by the **Restart/Update** button to auto-update. Set repo to `https://github.com/cineflow-web/CineFlow_Watch` and branch to `master`. |
...
```bash
git clone https://github.com/cineflow-web/CineFlow_Watch
cd CineFlow_Watch
cp sample_config.env config.env
nano config.env
```
...
Open the repo and tap **⭐ Star** at the top right → [github.com/cineflow-web/CineFlow_Watch](https://github.com/cineflow-web/CineFlow_Watch)
